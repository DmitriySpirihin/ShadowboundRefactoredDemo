...
[![Unity 2022 LTS](https://img.shields.io/badge/Unity-2022_LTS-222222?logo=unity&style=for-the-badge)](https://unity.com)
...
- **Комбо-механика через концентрацию**: каждый успешный удар восстанавливает концентрацию и усиливает урон (`урон × (1 + hits/10)`)
...
- **Текущее здоровье** (`tempHealth`) и **базовое здоровье** (`health`)
- **Механика кровотечения**: после боя здоровье медленно «стекает» до базового значения
...
- **Обход препятствий**: прыжки через узкие проходы, реакция на пропасти
