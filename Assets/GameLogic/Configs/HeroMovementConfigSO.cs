...
public class HeroMovementConfigSO : ScriptableObject
{
    ...
    [Range(0f, 35f)] public float JumpStamina = 8f;
    [Range(3f, 30f)] public float DoubleJumpStamina = 12f;
    [Range(2f, 30f)] public float WallJumpStamina = 5f;
    [Range(2f, 30f)] public float RollStamina = 11f;
    [Range(2f, 30f)] public float ParryStamina = 3f;
